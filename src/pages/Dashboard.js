  ...
  return (
    <div className="db-card db-energy-card" style={{ '--accent': accentColor }}>
      ...
      <div className="db-energy-card__head">
        <div
          className="db-energy-card__icon-wrap"
      ...
      <div className="db-energy-card__value">
        {value}
        <span className="db-energy-card__unit">{unit}</span>
      </div>

      <div className="db-energy-card__label">
        {label}
      </div>
  ...
  return (
    <div className="db-temp-gauge">
      ...
      <div className="db-temp-gauge__track">
        ...
        <div
          className="db-temp-gauge__marker"
          style={{ left: `${pct}%` }}
        />
      ...
      <div className="db-temp-gauge__labels">
        <span>{min}°C</span>
        <span className="db-temp-gauge__safe">
          Safe: 20 – 40°C
        </span>
        <span>{max}°C</span>
      </div>
  ...
  return (
    <div className="db-light-grid">
      ...
      {Array.from({ length: total }).map((_, i) => (
        <span
          key={i}
          className={`db-light-dot ${
            i < working
              ? 'db-light-dot--on'
              : 'db-light-dot--off'
          }`}
          title={`SL-${String(i + 1).padStart(3, '0')}: ${
            i < working
              ? 'Working'
              : 'Fault'
          }`}
...
function FlowNode({ icon, label, sub, highlight }) {
  return (
    <div
      className={`db-flow-node ${
        highlight
          ? 'db-flow-node--highlight'
          : ''
      }`}
    >

      <div className="db-flow-node__bubble">
        {icon}
      </div>

      <div className="db-flow-node__label">
        {label}
      </div>

      {sub && (
        <div className="db-flow-node__sub">
          {sub}
        </div>
      )}
...
function FlowConnector({ animated }) {
  return (
    <div className="db-flow-connector">
      ...
      <div
        className={`db-flow-connector__line ${
          animated
            ? 'db-flow-connector__line--animated'
            : ''
        }`}
      />

      <div className="db-flow-connector__arrow">
        ›
      </div>
...
/* ─────────────────────────────────────────
   LIVE SOLAR CURRENT CALCULATION
...
function getSolarCurrent(voltage) {
  ...
  if (v <= 5) return 1.000;
  if (v <= 10) return 1.025;
  if (v <= 15) return 1.050;
  if (v <= 20) return 1.075;
...
export default function Dashboard() {
    ...
    async function fetchData() {
      ...
      try {
        ...
        if (!cancelled) {
          ...
          setError(
            'Could not load dashboard data. Showing last known values.'
          );
  ...
  const total =
    data.working_lights +
    data.non_working_lights;

  const workingPct =
    total > 0
      ? Math.round(
          (data.working_lights / total) *
            100
        )
      : 0;
  ...
  const liveSolarVoltage =
    Number(solarVoltage) || 0;

  const liveSolarCurrent =
    getSolarCurrent(
      liveSolarVoltage
    );
  ...
  */
  const liveSolarPowerW =
    liveSolarVoltage *
    liveSolarCurrent;

  /*
    Energy = Power × 12 hours

    W × h = Wh
    Wh / 1000 = kWh
  */
  const liveSolarEnergy =
    (liveSolarPowerW * 12) /
    1000;
  ...
  const liveFootstepEnergy =
    Number(data.footstep_energy) || 0;

  /* ───────────────────────────────────────
     TOTAL RENEWABLE ENERGY
  ─────────────────────────────────────── */

  const liveTotalRenewableEnergy =
    liveSolarEnergy +
    liveFootstepEnergy;
  ...
  /* ───────────────────────────────────────
     ...
     Uses LIVE Solar + existing Footstep
  ─────────────────────────────────────── */

  const solarPct =
    liveTotalRenewableEnergy > 0
      ? Math.round(
          (liveSolarEnergy /
            liveTotalRenewableEnergy) *
            100
        )
      : 0;
    ...
    <div className="db-root">
      ...
      <div className="db-page-header">
        ...
        <div className="db-page-header__left">
          ...
          <h1 className="db-page-title">
            ...
            <span className="db-page-title__icon">
              🌿
            </span>
        ...
        <div className="db-page-header__right">
          ...
          <div className="db-header-stat">
            ...
            <span className="db-header-stat__label">
              Uptime
            </span>
      ...
      <section className="db-section">
        ...
        <SectionHeading
          ...
          subtitle="Current output from all renewable sources"
        />
        ...
        <div className="db-grid-3">
          ...
          <EnergyCard
            ...
            accentColor="#f59e0b"
            label="Solar Energy"
            value={liveSolarEnergy.toFixed(4)}
            unit=" kWh"
            status="Generating"
            pillColor="yellow"
          />
          ...
          <EnergyCard
            ...
            value={liveTotalRenewableEnergy.toFixed(4)}
            unit=" kWh"
            status="Active"
            pillColor="green"
          />
      ...
      <section className="db-section">
        ...
        <SectionHeading
          ...
          subtitle="Storage level and thermal status"
        />
        ...
        <div className="db-grid-2">
          ...
          <div className="db-card db-batt-card">
            ...
            <div className="db-batt-card__head">
              ...
              <div
                className="db-batt-card__icon-box"
                style={{
                  background: '#ccfbf1',
                }}
              >
            ...
            <div className="db-batt-card__meta">
              ...
              <div className="db-meta-item">
                <span className="db-meta-item__label">
                  Capacity
                </span>
                <span className="db-meta-item__value">
                  200 Ah
                </span>
              </div>
      ...
      <section className="db-section">
        ...
        >
          ...
          <div className="db-card db-sl-card db-sl-card--total">
            ...
            <div className="db-sl-card__num">
              {total}
            </div>

            <div className="db-sl-card__label">
              Total Lights
            </div>

            <div className="db-sl-card__sub">
              Across all zones
            </div>
          ...
          <div className="db-card db-sl-card db-sl-card--working">
            ...
            <div className="db-sl-card__num db-sl-card__num--green">
              {data.working_lights}
            </div>
            ...
            <div className="db-sl-card__progress">
              ...
              <div
                className="db-sl-card__progress-fill db-sl-card__progress-fill--green"
                style={{
                  width: `${workingPct}%`,
                }}
              />
          ...
          <div className="db-card db-sl-card db-sl-card--fault">
            ...
            <div className="db-sl-card__num db-sl-card__num--red">
              {data.non_working_lights}
            </div>
            ...
            <div className="db-sl-card__progress">
              ...
              <div
                className="db-sl-card__progress-fill db-sl-card__progress-fill--red"
                style={{
                  width: `${nonWorkingPct}%`,
                }}
              />
        ...
        <div className="db-card db-sl-grid-card">
          ...
          <div className="db-sl-grid-header">
            ...
            <span className="db-sl-legend db-sl-legend--on">
              <span />
              Working ({data.working_lights})
            </span>

            <span className="db-sl-legend db-sl-legend--off">
              <span />
              Non-working ({data.non_working_lights})
            </span>

            <span className="db-sl-grid-note">
              Hover a dot to see light ID
            </span>
      ...
      <section className="db-section">
        ...
        <SectionHeading
          ...
          subtitle="Today's savings from renewable energy generation"
        />
          ...
          <div className="db-card db-impact-card db-impact-card--co2">
            ...
            <div className="db-impact-card__body">
              ...
              <div className="db-impact-card__icon-col">
                ...
                <div className="db-impact-card__icon-circle db-impact-card__icon-circle--green">
                  🌿
                </div>
              ...
              <div className="db-impact-card__main">
                ...
                <div className="db-impact-value">
                  ...
                  <span className="db-impact-unit">
                    {' '}kg
                  </span>

                </div>

                <div className="db-impact-note">
                  ≈ {(data.co2_saved / 11.7).toFixed(1)} trees worth of CO₂ absorbed
                </div>
            ...
            <div className="db-impact-card__stats">
              ...
              <div className="db-impact-stat">
                <span>This Week</span>
                <strong>168 kg</strong>
              </div>

              <div className="db-impact-stat">
                <span>This Month</span>
                <strong>612 kg</strong>
              </div>

              <div className="db-impact-stat">
                <span>This Year</span>
                <strong>4,820 kg</strong>
              </div>
          ...
          <div className="db-card db-impact-card db-impact-card--cost">
            ...
            <div className="db-impact-card__body">
              ...
              <div className="db-impact-card__icon-col">
                ...
                <div className="db-impact-card__icon-circle db-impact-card__icon-circle--purple">
                  💰
                </div>
      ...
      <section className="db-section">
        ...
        <SectionHeading
          icon="🔄"
          title="Energy Flow"
          subtitle="Live path from generation sources to consumption"
        />
        ...
        <div className="db-card db-flow-card">
          ...
          <div className="db-flow-source-label">
            ...
            <span className="db-flow-source-badge db-flow-source-badge--solar">
              ☀️ Solar Path
            </span>
          ...
          <div className="db-flow-row">
            ...
            <FlowNode
              icon="☀️"
              label="Solar Panel"
              sub={`${liveSolarEnergy.toFixed(4)} kWh`}
              highlight
            />
            ...
            <FlowNode
              ...
              sub={`${liveTotalRenewableEnergy.toFixed(4)} kWh total`}
              highlight
            />
            ...
            <FlowNode
              ...
              sub={`${data.battery_level}% charged`}
              highlight
            />
          ...
          <div className="db-flow-separator">
            ...
            <span className="db-flow-separator__label">
              + combined into
            </span>
          ...
          <div className="db-flow-source-label">
            ...
            <span className="db-flow-source-badge db-flow-source-badge--foot">
              👣 Footstep Path
            </span>
          ...
          <div className="db-flow-row db-flow-row--dim">
            ...
            <FlowNode
              icon="👣"
              label="Footstep Generator"
              sub={`${data.footstep_energy} kWh`}
            />
      ...
      <section className="db-section">
        ...
        <SectionHeading
          ...
          subtitle="Live health check of all subsystems"
        />
            ...
            {QUICK_STATUS.map(
              ({
                ...
                >
                  ...
                  <div className="db-status-item__icon">
                    {icon}
                  </div>

                  <div className="db-status-item__body">

                    <div className="db-status-item__label">
                      {label}
                    </div>

                    <div className="db-status-item__value">
                      {value}
                    </div>

                  </div>

                  <StatusPill color={pill}>
                    {value}
                  </StatusPill>
      ...
      <section className="db-section">
        ...
        <SectionHeading
          ...
          subtitle="Generation trends and source breakdown"
        />
        ...
        >
          ...
          <ChartCard
            ...
            subtitle="Solar vs Footstep output (kWh)"
          >
          ...
          <ChartCard
            ...
            subtitle="Contribution share today (%)"
          >
        ...
        <ChartCard
          title="Weekly Energy Output"
          subtitle="Total kWh generated per day this week"
        >
